...
def get_rope_index_modified(
    ...
    if image_grid_thw is not None or video_grid_thw is not None:
        ...
        for i, input_ids in enumerate(total_input_ids):
            if False and attention_mask is not None:  # temporarily disable masked token trimming
            ...
            for _ in range(image_nums + video_nums):
                if (
                    image_token_id in input_tokens and remain_images > 0
                ):
            ...
            position_ids[..., i, torch.ones_like(attention_mask[i], dtype=torch.bool)] = (
